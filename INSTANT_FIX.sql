-- INSTANT FIX - Run this to fix everything!
-- This will delete the broken database and create a perfect one
...
-- ============================================================================
-- PARAPHARMACIE TABLE (CORRECT SCHEMA)
-- ============================================================================
...
('michael@example.com', 'Michael Johnson', 'dr.anderson@clinic.com', 'Dr. Anderson', '2026-04-22 09:00:00', 'pending', 'Consultation');
