...
final class Version20260218222100 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add reset_token and reset_token_expires_at columns to user table for password reset feature';
    }
