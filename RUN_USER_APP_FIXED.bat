@echo off
REM USER-FACING APPLICATION - Fixed Path Version

cd /d "C:\Users\driss\Downloads\Esprit-PIDEV-3A46-2526-PinkShield-projet_java\Esprit-PIDEV-3A46-2526-PinkShield-projet_java"
...
"C:\xampp\mysql\bin\mysql.exe" -u root pinkshield_db < EMERGENCY_DB_FIX.sql >nul 2>&1

echo Recompiling application...
setlocal enabledelayedexpansion

set PROJECT_DIR=C:\Users\driss\Downloads\Esprit-PIDEV-3A46-2526-PinkShield-projet_java\Esprit-PIDEV-3A46-2526-PinkShield-projet_java
