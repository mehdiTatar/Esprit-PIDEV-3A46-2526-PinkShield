 ...
 */
class getDailyTrackingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DailyTrackingRepository' shared autowired service.
     *
     * @return \App\Repository\DailyTrackingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DailyTrackingRepository.php';

        return $container->privates['App\\Repository\\DailyTrackingRepository'] = new \App\Repository\DailyTrackingRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
