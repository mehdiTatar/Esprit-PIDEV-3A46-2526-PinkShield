...
class getForm_TypeExtension_CsrfService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.type_extension.csrf'] = new \Symfony\Component\Form\Extension\Csrf\Type\FormTypeCsrfExtension(($container->privates['security.csrf.token_manager'] ?? self::getSecurity_Csrf_TokenManagerService($container)), true, '_csrf_token', NULL, 'validators', ($container->privates['form.server_params'] ?? $container->load('getForm_ServerParamsService')), $container->parameters['form.type_extension.csrf.field_attr'], ['App\\Form\\AdminFormType' => NULL, 'App\\Form\\AppointmentFormType' => NULL, 'App\\Form\\DoctorFormType' => NULL, 'App\\Form\\ParapharmacieType' => NULL, 'App\\Form\\RatingFormType' => NULL, 'App\\Form\\UserFormType' => NULL]);
    }
}
