 ...
 */
class getParapharmacieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParapharmacieRepository' shared autowired service.
     *
     * @return \App\Repository\ParapharmacieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParapharmacieRepository.php';

        return $container->privates['App\\Repository\\ParapharmacieRepository'] = new \App\Repository\ParapharmacieRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
