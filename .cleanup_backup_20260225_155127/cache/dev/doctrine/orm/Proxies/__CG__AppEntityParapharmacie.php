 ...
 */
class Parapharmacie extends \App\Entity\Parapharmacie implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'appointment' => [parent::class, 'appointment', null, 16],
        ...
        'appointment' => [parent::class, 'appointment', null, 16],
