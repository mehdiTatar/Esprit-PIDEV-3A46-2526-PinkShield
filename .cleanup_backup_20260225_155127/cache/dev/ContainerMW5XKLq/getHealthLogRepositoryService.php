 ...
 */
class getHealthLogRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HealthLogRepository' shared autowired service.
     *
     * @return \App\Repository\HealthLogRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HealthLogRepository.php';

        return $container->privates['App\\Repository\\HealthLogRepository'] = new \App\Repository\HealthLogRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
